  ...
  return (
    <div className="portal-hero">
      <div className="portal-hero-content">
        ...
        {/* RIGHT SIDE */}
        {user && !isLoginPage && (
          <div className="portal-user-wrapper" ref={menuRef}>
            <div
            ...
            >
              <div className="profile-card">
                <div className="profile-details">
                  ...
                  <div className="profile-role">{user?.designation}</div>
                </div>
              </div>
            </div>
              ...
              <div className="portal-dropdown">
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    setShowMenu(false);
                    window.location.replace("/HostelLogin");
                  }}
                >
                  🚪 Logout
                </div>
